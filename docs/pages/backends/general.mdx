...
Ivy supports two backends out of the box: [Thingsboard](https://thingsboard.io/) and [Tenta](https://tenta.onrender.com/). It uses the MQTT protocol to communicate with them. These backends are run as regular procedures – they run in a thread and are started by the mainloop on DAS startup.
