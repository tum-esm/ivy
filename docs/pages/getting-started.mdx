...
You need to have [Python](https://www.python.org/) version 3.10 or higher and [git](https://git-scm.com/) installed on your machine. We officially only support Unix operating systems. Click on the "Use this template" button on the [Ivy Repository](https://github.com/tum-esm/ivy) to start your own DAS repository:
...
curl -s https://raw.githubusercontent.com/tum-esm/ivy/refs/heads/main/scripts/setup_development.py | python3
```
...
```bash
# optional: change the Python interpreter to the one you want your DAS to run with
curl -s https://raw.githubusercontent.com/tum-esm/ivy/refs/heads/main/scripts/setup_production.py | python3
```
