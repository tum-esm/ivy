...
Steps 2 through 6 of the development setup have been automated by running the following command. It will ask you for the necessary inputs:
...
**6. Run the quick tests to check your setup**
...
**7. Run the integration tests to fully validate your setup**
...
**9. Observe the outputs of the system**
...
**10. Update and build the documentation**
...
**11. Add your sensor-network specific code to the DAS**
...
**12. Test a new version of your DAS**
