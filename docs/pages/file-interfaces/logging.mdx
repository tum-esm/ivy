...
The config has a section "logging_verbosity", where you can define the minimum levels for: 1. printing to console, 2. writing to log files, 3. sending as messages (see [next section](/file-interfaces/messages)).
