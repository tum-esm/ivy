...
Both WSNs and ROS are complementary to Ivy. One could use Ivy to operate the base station of a WSN, and Ivy is perfectly suited to run as a ROS node. We plan to include an option to run Ivy in a ROS environment in an upcoming release.
