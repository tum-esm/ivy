...
The goal of this publication is to share a reference architecture of how a reliable DAS can be built. We do not claim that Ivy is the best or the only architecture for this use case and are glad to see similar efforts inspired by Ivy.
